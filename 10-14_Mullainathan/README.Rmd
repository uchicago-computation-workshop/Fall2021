...
week_folder <- "10-14_Mullainathan"


title <- "Algorithmic Behavioral Science: Automated Discovery of Human Biases"
...
#Update Weekly
issues_url <- "https://github.com/uchicago-computation-workshop/Fall2021/issues/4"
zoom_url <- "https://uchicago.zoom.us/j/95981728771?pwd=SWdIcmVYeDFINmZpaldkbmsxUmN4dz09"


#Papers

week_paper_ref0 <- "Kleinberg, Jon, Jens Ludwig, Sendhil Mullainathan, and Ziad Obermeyer. 2015. 'Prediction Policy Problems.' American Economic Review, 105 (5): 491-95."
week_paper_file0 <- "https://www.aeaweb.org/articles?id=10.1257/aer.p20151023"
...
**Attendance**: The talk will be held in Rm 295 of 1155 East 60th St. MACSS students who have a last name starting with A through L (Group 1) are required to attend this week's talk in person. Due to capacity constraint, the rest of MACSS students (Group 2) and all other attendees will need to join the meeting via Zoom ([link](`r zoom_url`)) this week.


**Participation**: Students in the Masters of Computational Social Science program are expected to attend and join the discussion by posting a comment on the issues <a href= `r issues_url`> page </a> of the <a href="https://github.com/uchicago-computation-workshop"> workshop's public repository.</a></p>
